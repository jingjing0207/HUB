...
class SearchInputChange extends Component {
    state = {
        size: 'default',
        currentPage:1,
        currentSize:15
    ...
    searchChange=(value)=>{
        ...
        // this.props.blurSearchQuery(value,this.props.page-1,this.props.size)
        this.props.blurSearchQuery(value,this.state.currentPage-1,this.state.currentSize)
    }
    render() {
